...
parser.add_argument("--x", "-x",required=False,action='store_true',help="Ignore indels in the GO2 dataset; default: false")
...
for v in go2_list:
    ...
    elif not isSNP(v) and no_indels:
        print("# IGNORING INDEL %s" %(v),file=sys.stdout)
    else:
