...
PYTHONPATH="${upperdir}"/python "$hesin_script" -p "OA" -r "$hesin_release" --icd9 "$tempfiles[tmp_icd9_incl]" --icd10 "$tempfiles[tmp_icd10_incl]" -o "$tempfiles[tmp_inclusion_out]" 2>>"$logfile"
